...
Если вам нужно разделить строки на несколько строк(линий) в коде, но при этом сохранить переносы строк
в выводе, вы должны явно указать символ переноса строки `\n`.
...
Теперь, в отличие от предыдущего примера, строки разделены на несколько строк(линий) в выводе,
...
Но полезно понимать, что они существуют и как с ними работать, если когда-то такая необходимость возникнет.
</details>
...
Вы освоили основные принципы языка и теперь готовы к новым вызовам. 
